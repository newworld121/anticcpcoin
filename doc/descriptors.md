# Support for Output Descriptors in Anticcpcoin Core

Since Anticcpcoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Anticcpcoin Core wallets, a convenience function `combo` is
