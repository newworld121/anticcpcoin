Anticcpcoin Core version *0.15.1* is now available from:

  <https://download.anticcpcoin.org/anticcpcoin-0.15.1/>
...
A number of changes to the way Anticcpcoin Core deals with peer connections and invalid blocks
