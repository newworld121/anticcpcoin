...
"""Verify that starting anticcpcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start anticcpcoin with -h for help text")
        ...
        self.log.info("Start anticcpcoin with -version for version information")
        ...
        self.log.info("Start anticcpcoind with -fakearg to make sure it does not start")
