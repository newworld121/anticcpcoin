Contributing to Anticcpcoin Core
============================

The Anticcpcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Anticcpcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/anticcpcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to anticcpcoin-qt
...
The following applies to code changes to the Anticcpcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Anticcpcoin
Network Protocol consensus changes.

Whether a pull request is merged into Anticcpcoin Core rests with the project merge
...
Patches that change Anticcpcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Anticcpcoin consensus, it must have been
...
The project leader is the release manager for each Anticcpcoin Core release.
