...
{
    const char* pszTimestamp = "Anti ccp from 2021";
    const CScript genesisOutputScript = CScript() << ParseHex("036184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x948238ba0c6f83c39cbd677aa7fa234975246b5c0704626bbacc64ddf0a21527");
        ...
        consensus.CSVHeight = 25262; // 53e0af7626f7f51ce9f3b6cfc36508a5b1d2f6c4a75ac215dc079442692a4c0b
        consensus.SegwitHeight = 25262; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        consensus.MinBIP9WarningHeight = 35326; // segwit activation height + miner confirmation window
        ...
        genesis = CreateGenesisBlock(1639397826, 2000113427, 0x1e0ffff0, 1, 50000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x948238ba0c6f83c39cbd677aa7fa234975246b5c0704626bbacc64ddf0a21527"));
        assert(genesis.hashMerkleRoot == uint256S("0x6b94c01f45dc5e5a41df56cd44dd9c6ac6e2bcad8b94c381fb65f527b03ee2e2"));
        ...
        vSeeds.emplace_back("dnsseed.anticcpcoin.com");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.anticcpcointools.com");
        //vSeeds.emplace_back("dnsseed.anticcpcoinpool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x948238ba0c6f83c39cbd677aa7fa234975246b5c0704626bbacc64ddf0a21527")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1639397826, 416565, 0x1e0ffff0, 1, 50000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x69dac113e74e18964a7359f9e7993197f1fed9e72ab0403acb6081ad86fd50bf"));
        assert(genesis.hashMerkleRoot == uint256S("0x6b94c01f45dc5e5a41df56cd44dd9c6ac6e2bcad8b94c381fb65f527b03ee2e2"));
        ...
        vSeeds.emplace_back("dnsseed.anticcpcoin.com");
        //vSeeds.emplace_back("seed-b.anticcpcoin.loshan.co.uk");
        ...
        checkpointData = {
            {
                {0, uint256S("0x69dac113e74e18964a7359f9e7993197f1fed9e72ab0403acb6081ad86fd50bf")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1639397826, 2, 0x207fffff, 1, 50000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x54c06655fa3ac098a258bfd4c1647ff887537e65922b678836cc0269fa3c70c2"));
        assert(genesis.hashMerkleRoot == uint256S("0x6b94c01f45dc5e5a41df56cd44dd9c6ac6e2bcad8b94c381fb65f527b03ee2e2"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x54c06655fa3ac098a258bfd4c1647ff887537e65922b678836cc0269fa3c70c2")},
            }
        };
