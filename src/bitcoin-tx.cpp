...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " anticcpcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  anticcpcoin-tx [options] <hex-tx> [commands]  Update hex-encoded anticcpcoin transaction\n" +
            "or:     anticcpcoin-tx [options] -create [commands]   Create hex-encoded anticcpcoin transaction\n" +
            "\n";
